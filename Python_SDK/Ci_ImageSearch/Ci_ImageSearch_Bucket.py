...
key = '/ImageSearchBucket' #用于开通以图搜图的请求路径，请勿修改！
maxcapacity = 10000        #图库容量限制，公测期间最大不超过5000W
maxqps = 10                #图库访问限制，默认10，公测期间请勿修改
host = bucket + '.ci.' + region + '.myqcloud.com'                 #生成此次请求用的HOST
url = scheme + '://' + host + key
jsonbody = {"Request": [{"MaxCapacity": maxcapacity, "MaxQps": maxqps}]}
...
if response.status_code == 200:
    print(f'\033[0;32mSuccess Open ImageSearch Service!\033[0m')
